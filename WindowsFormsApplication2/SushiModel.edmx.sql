...
-- --------------------------------------------------
-- Date Created: 05/14/2014 00:35:18
-- Generated from EDMX file: c:\users\olgusin\documents\visual studio 2012\Projects\WindowsFormsApplication2\WindowsFormsApplication2\SushiModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_UnitDimentionNomenclature]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NomenclatureНабор] DROP CONSTRAINT [FK_UnitDimentionNomenclature];
GO
IF OBJECT_ID(N'[dbo].[FK_CategoryNomenclature]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NomenclatureНабор] DROP CONSTRAINT [FK_CategoryNomenclature];
GO
IF OBJECT_ID(N'[dbo].[FK_UnitDimentionProductCompose]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductComposeNumber] DROP CONSTRAINT [FK_UnitDimentionProductCompose];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonUser]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserNumber] DROP CONSTRAINT [FK_PersonUser];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonPasport]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PasportNumber] DROP CONSTRAINT [FK_PersonPasport];
GO
IF OBJECT_ID(N'[dbo].[FK_PostEmployee]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmployeeNumber] DROP CONSTRAINT [FK_PostEmployee];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonEmployee]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmployeeNumber] DROP CONSTRAINT [FK_PersonEmployee];
GO
IF OBJECT_ID(N'[dbo].[FK_EmployeeDuty]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DutyNumber] DROP CONSTRAINT [FK_EmployeeDuty];
GO
IF OBJECT_ID(N'[dbo].[FK_StoreStore]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StoreNumber] DROP CONSTRAINT [FK_StoreStore];
GO
IF OBJECT_ID(N'[dbo].[FK_DocumentTypeDocument]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DocumentNumber] DROP CONSTRAINT [FK_DocumentTypeDocument];
GO
IF OBJECT_ID(N'[dbo].[FK_StoreDocument]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DocumentNumber] DROP CONSTRAINT [FK_StoreDocument];
GO
IF OBJECT_ID(N'[dbo].[FK_ChangeTypeStoreGoods]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StoreGoodsNumber] DROP CONSTRAINT [FK_ChangeTypeStoreGoods];
GO
IF OBJECT_ID(N'[dbo].[FK_DocumentStoreGoods]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StoreGoodsNumber] DROP CONSTRAINT [FK_DocumentStoreGoods];
GO
IF OBJECT_ID(N'[dbo].[FK_StoreStoreGoods]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StoreGoodsNumber] DROP CONSTRAINT [FK_StoreStoreGoods];
GO
IF OBJECT_ID(N'[dbo].[FK_AdressOrderDelivery]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderDeliveryNumber] DROP CONSTRAINT [FK_AdressOrderDelivery];
GO
IF OBJECT_ID(N'[dbo].[FK_OrderStatusOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_OrderStatusOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_PersonOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_DeliveryTypeOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_DeliveryTypeOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_OrderDeliveryOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_OrderDeliveryOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_PlaceOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_PlaceOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_DutyOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrderNumber] DROP CONSTRAINT [FK_DutyOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_NomenclatureProductCompose]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductComposeNumber] DROP CONSTRAINT [FK_NomenclatureProductCompose];
GO
IF OBJECT_ID(N'[dbo].[FK_NomenclatureProductCompose1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductComposeNumber] DROP CONSTRAINT [FK_NomenclatureProductCompose1];
GO
IF OBJECT_ID(N'[dbo].[FK_NomenclatureStoreGoods]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StoreGoodsNumber] DROP CONSTRAINT [FK_NomenclatureStoreGoods];
GO
...
IF OBJECT_ID(N'[dbo].[Unit_dimentionNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Unit_dimentionNumber];
GO
IF OBJECT_ID(N'[dbo].[CategoryNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CategoryNumber];
GO
IF OBJECT_ID(N'[dbo].[ProductComposeNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ProductComposeNumber];
GO
IF OBJECT_ID(N'[dbo].[UserNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserNumber];
GO
IF OBJECT_ID(N'[dbo].[PersonNmber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PersonNmber];
GO
IF OBJECT_ID(N'[dbo].[PasportNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PasportNumber];
GO
IF OBJECT_ID(N'[dbo].[PostNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PostNumber];
GO
IF OBJECT_ID(N'[dbo].[EmployeeNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EmployeeNumber];
GO
IF OBJECT_ID(N'[dbo].[DutyNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DutyNumber];
GO
IF OBJECT_ID(N'[dbo].[ChangeTypeНабор]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ChangeTypeНабор];
GO
IF OBJECT_ID(N'[dbo].[OrderStatusNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[OrderStatusNumber];
GO
IF OBJECT_ID(N'[dbo].[DeliveryTypeNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DeliveryTypeNumber];
GO
IF OBJECT_ID(N'[dbo].[StoreNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[StoreNumber];
GO
IF OBJECT_ID(N'[dbo].[StoreGoodsNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[StoreGoodsNumber];
GO
IF OBJECT_ID(N'[dbo].[DocumentNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DocumentNumber];
GO
IF OBJECT_ID(N'[dbo].[DocumentTypeNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DocumentTypeNumber];
GO
IF OBJECT_ID(N'[dbo].[AdressNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[AdressNumber];
GO
IF OBJECT_ID(N'[dbo].[PlaceNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PlaceNumber];
GO
IF OBJECT_ID(N'[dbo].[OrderDeliveryNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[OrderDeliveryNumber];
GO
IF OBJECT_ID(N'[dbo].[OrderNumber]', 'U') IS NOT NULL
    DROP TABLE [dbo].[OrderNumber];
GO
IF OBJECT_ID(N'[dbo].[NomenclatureНабор]', 'U') IS NOT NULL
    DROP TABLE [dbo].[NomenclatureНабор];
GO
